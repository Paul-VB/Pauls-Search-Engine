...
:QuickSearch
TITLE PSE 7.0 -Quck search mode
CLS
...
:FullSearch
CLS
TITLE PSE 7.0 -Full search mode
ECHO Searching for "%PAR%". This may take a long time. Please wait...
DIR /S /B /D /O:-S /-C "C:\*%PAR%*.*" > "C:\PSE\RAWResults.txt"
